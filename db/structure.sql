...
--
-- Name: index_comments_on_place_id; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: index_comments_on_user_id_and_place_id; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX index_comments_on_user_id_and_place_id ON comments USING btree (user_id, place_id);
